...
<?php $__env->startSection('content'); ?>
            ...
            <div class="container">
                <form action="<?php echo e(route('updateProduct', $product->id)); ?>" method="post" class="marginTopXL" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
                    <p class="title">Изменить товар</p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\OSPanel\domains\giftStore\resources\views/pages/editProduct.blade.php ENDPATH**/ ?>