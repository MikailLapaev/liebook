...
<?php $__env->startSection('content'); ?>
            ...
            <div class="container">
                <form action="<?php echo e(route('storeProduct')); ?>" method="post" class="marginTopXL" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="labels">
                            <input type="text" class="definput" id="price" name="price" placeholder="Цена">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\OSPanel\domains\giftStore\resources\views/pages/createProduct.blade.php ENDPATH**/ ?>