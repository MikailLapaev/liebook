        ...
        <div class="catalog container-block col mt-100">
            ...
            <div class="container-block row">
                ...
                <div class="pagination-btn row">
                    <div class="btn-2">
                        <a href="<?php echo e(route('catalogPage')); ?>">Смотреть еще подарки →</a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\liebook\resources\views/pages/index.blade.php ENDPATH**/ ?>